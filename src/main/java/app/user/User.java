...
public class User {
    ...
    /**
    Creates a new User object, filling in all parameters with empty strings 
    and other placeholder values.
    */
	public User() {
		super();
		this.userID = "";
  	...
  	/**
    Creates a new User object, with specified user information.
    ...
    */
	public void setFilingStatus(String filingStatus) {
  	...
  	/**
    Creates and returns a string representing a user, listing their registration
    information.
